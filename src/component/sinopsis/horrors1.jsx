  ...
  <div className="component">
    <div className="story-details">
      <div className="story-header">
       <div className="cover">
        <img className="rounded-lg" src={Hod}/>
       </div>
       <div className='story-info'>
         <span className="sr-only">Hide or Die</span>
         <div aria-hidden="true" class="story-info__title">Hide or Die</div>
         <ul className='flex'>
           ...
           <li className="mx-[20px] border-r ">
             ...
             <div className="icon-container" aria-hidden="true">
               <div data-tip="" class="tool-tip" currentitem="false">
                 <span className="stats-value" aria-hidden="true">12,7k</span>
               </div>
             </div>
           </li>
          ...
          <a href="https://www.wattpad.com/story/358214629-the-closet-game-nct-127-%C3%97-nct-dream-on-hold"><button className="bg-gray-800 py-[10px] px-[50px] rounded-full  mt-[50px] text-lg text-white">Mulai Membaca</button></a>
       </div>
      </div>
    </div>
    <div className="flex mt-[100px] ml-[100px]">
      <img className="rounded-full mr-[10px] w-[30px]" src="https://img.wattpad.com/useravatar/coffeejeman.128.32645.jpg" alt="btr" />
      <p className="font-semibold">coffeejeman</p>
      </div>
    <div>
      <p class="text-justify w-[50rem] ml-[260px] mt-[70px]">Permainan petak umpet dimulai. Sembunyi jangan biarkan dia menemukanmu atau kamu akan mati.
        <br/>
     <p className="text-center mt-[35px]">***</p> 
        <br/>
        "Pesen gue cuma dua, kalau lu mau selamat dari permainan ini, jangan pernah buka pintu kalau ada yang ngetok, dan jangan pernah nengok ke belakang setelah mendengar suara bisikan."
