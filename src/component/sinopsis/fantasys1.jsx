  ...
  <div className="component">
    <div className="story-details">
      <div className="story-header">
       <div className="cover">
        <img className="rounded-lg" src={Ntdfe}/>
       </div>
       <div className='story-info'>
         <span className="sr-only">Nemesis The Demon from Empire</span>
         <div aria-hidden="true" class="story-info__title">Nemesis The Demon from Empire</div>
         <ul className='flex'>
           ...
           <li className="mx-[20px] border-r ">
             ...
             <div className="icon-container" aria-hidden="true">
               <div data-tip="337,555" class="tool-tip" currentitem="false">
                 <span className="stats-value" aria-hidden="true">347K</span>
               </div>
             </div>
           </li>
           <li className="mx-[20px]">
            ...
            {/*  <!-- Dropdown select element for chapters --> */}
