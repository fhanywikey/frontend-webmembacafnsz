  ...
  <div className="component">
    <div className="story-details">
      <div className="story-header">
       <div className="cover">
        <img className="rounded-lg" src={Btr}/>
       </div>
       <div className='story-info'>
         <div aria-hidden="true" class="story-info__title">Behind The Rush</div>
         <ul className='flex'>
           <li className='mx-[20px] border-r'>
             ...
             <div className='icon-container'>
               <div data-tip="5,182,264" class="tool-tip" currentitem="false">
                 <span className="stats-value" aria-hidden="true">320k</span>
               </div>
             </div>
           </li>
           <li className="mx-[20px] border-r ">
             ...
             <div className="icon-container" aria-hidden="true">
               <div data-tip="337,555" class="tool-tip" currentitem="false">
                 <span className="stats-value" aria-hidden="true">48.6k</span>
               </div>
             </div>
           </li>
    ...
    <div className="flex mt-[100px] ml-[100px]">
      <img className="rounded-full mr-[10px] w-[30px] " src="https://img.wattpad.com/useravatar/raatommo.128.355097.jpg" alt="btr" />
      <p className="font-semibold">raatommo</p>
      </div>
    <div>
      <p class="text-justify w-[50rem] ml-[260px] mt-[70px]">Ketika tempat teraman di seluruh dunia baru ini tak lagi menjadi tujuannya. Mia Sanders kini berusaha mencari alasan baru untuk bertahan. Dengan usahanya sendiri, Mia ingin membuktikan kalau dia pantas untuk diterima. 
        <br/>
     <p className="text-center mt-[35px]">***</p> 
      ...
      Di tengah carut-marut keadaan, jalan keluar perlahan muncul. Tentu saja Mia tidak akan melepaskan kesempatan untuk menyelamatkan tempat yang dia anggap rumah. Meski rintangannya berat. Bahkan jika hubungannya dengan Alex merenggang. </p>
    </div>
    </div>
  </div>
